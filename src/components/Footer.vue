        ...
        <div class="containe fixed-bottom">
            <div class="row">
                ...
                <div class="col-4 right">
                    <div class="col size">
                        <div class="set">
                            <img src="https://i.postimg.cc/R0QVwjQk/pngegg-15.png" style="width: 12px; height: 12px" alt="">
                            <img src="https://i.postimg.cc/RFSCdXgN/pngegg-16.png" style="width: 15px; height: 12px;" alt="">
                            <img src="https://i.postimg.cc/W4P1F2rm/pngegg-17.png" style="width: 23px; height: 23px;" alt="">
                        </div>
                    </div>
                    <div class="col size">
                    ...
                    <div class="t-n">
                        <div class="col size time-noti">
                            <div class="time text-end">
                                ...
                                <p style="color: black;">22023/05/14</p>
                            </div>
                            <div class="noti">
...
.containe {
    ...
    background: rgba(177, 234, 252, 0.61);
    width: 100%;
}
