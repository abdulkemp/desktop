  ...
  <div>
      <div class="contain" v-for="pro in work" :key="pro">
          <!-- <div class="left-folders">
              <div class="desktop">
                  ...
                  <div class="fold justify-content-start">
                      <div class="forms">
                          <div class="folder">
                              <img src="https://i.postimg.cc/YC4KR1rt/pngwing-com.png" alt="" />
                          </div>
                          <div class="text">
                              <p>Microsoft Edge</p>
                          </div>
                  ...
                  <div class="fold justify-content-start">
                      <button type="button" data-bs-toggle="modal" data-bs-target="#spotify">
                          <div class="forms" style="height: 5rem">
                              <div class="folder spot">
          ...
          <!-- <div class="fold justify-content-start" v-for="pro in work" :key="pro" >
              ...
              <div class="modal fade" :id="`exampleModal${pro.id}`" tabindex="-1" aria-labelledby="exampleModalLabel"
                  aria-hidden="true">
                  <div class="modal-dialog modal-xl">
                      <div class="modal-content">
                          ...
                          <div class="modal-body">
                              <iframe :src="pro.frame" frameBorder="1"
    ...
    return {
      work: [
        ...
        },
        {
          ...
          image: "https://i.postimg.cc/rFR2C1FM/pngegg-5.png",
          frame: "https://github1s.com/abdulkemp/revision/blob",
          id: "3",
        },
        {
          text: "Git Bash",
          image: "https://i.postimg.cc/T3H883tR/pngegg-6.png",
          frame: "http://googlerep.netlify.app",
          id: "4",
        },
        {
          text: "Microsoft Edge",
          image: "https://i.postimg.cc/YC4KR1rt/pngwing-com.png",
          frame: "",
          id: "5",
        },
        {
          text: "Spotify",
          image: "https://i.postimg.cc/vH0xfdBp/pngwing-com-3.png",
          frame:
            "https://open.spotify.com/embed/playlist/6NW4DkIsHOoNymv5TJEXqC?utm_source=generator&theme=0",
          id: "6",
        },
      ],
    };
